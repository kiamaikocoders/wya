...
import { TERMS_EFFECTIVE_LABEL, CONTACT_TERMS_EMAIL, ATTENDEE_TERMS_VERSION } from '@/legal/policy-versions';
      ...
      <Card className="max-w-4xl mx-auto bg-gradient-to-br from-gradient-purple-medium/50 to-gradient-purple-bright/30/5">
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Effective {TERMS_EFFECTIVE_LABEL} · Version {ATTENDEE_TERMS_VERSION} · Contact:{' '}
            <a className="underline" href={`mailto:${CONTACT_TERMS_EMAIL}`}>
              {CONTACT_TERMS_EMAIL}
            </a>
          </p>
        </CardHeader>
        ...
        <CardContent>
          <ScrollArea className="h-[70vh]">
            <div className="pr-4">
              <PlainLegalBody text={ATTENDEE_TERMS_PLAIN} />

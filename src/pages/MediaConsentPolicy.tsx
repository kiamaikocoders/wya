      ...
      <Card className="max-w-4xl mx-auto bg-gradient-to-br from-gradient-purple-medium/50 to-gradient-purple-bright/30/5">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-2xl">
            <Video className="h-6 w-6 text-gradient-orange-accent" />
            Media consent
          </CardTitle>
          <p className="text-sm text-muted-foreground">
            Effective {TERMS_EFFECTIVE_LABEL} · Version {MEDIA_CONSENT_VERSION} · Contact:{' '}
        ...
        <CardContent>
          <ScrollArea className="h-[70vh]">
            <div className="pr-4">
              <PlainLegalBody text={MEDIA_CONSENT_PLAIN} />

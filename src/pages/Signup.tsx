            ...
            <div className="space-y-2">
              ...
              >
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="attendee" id="attendee" className="text-kenya-orange" />
                  <Label htmlFor="attendee" className="text-white">Attendee</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="organizer" id="organizer" className="text-kenya-orange" />

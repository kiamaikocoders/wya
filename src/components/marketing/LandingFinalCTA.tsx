...
const LandingFinalCTA = ({ onPrimary, onSecondary }: LandingFinalCTAProps) => {
  return (
    <section className="relative overflow-hidden py-20">
      ...
      <div className="absolute -right-10 top-1/3 -z-10 h-64 w-64 rounded-full bg-gradient-accent/25 blur-3xl" />
      ...
      <div className="container mx-auto rounded-3xl border border-white/15 bg-black/40 px-8 py-16 text-center shadow-[0_40px_120px_-60px_rgba(255,128,0,0.55)] backdrop-blur">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Button
            size="lg"
            onClick={onPrimary}
            className="w-full bg-gradient-to-r bg-gradient-accent text-kenya-dark font-semibold sm:w-auto"
          >
